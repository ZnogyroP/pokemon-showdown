...
export const Formats: (FormatsData | {section: string, column?: number})[] = [
	...
	
	{
        ...
        banlist: ['All Pokemon'],
        unbanlist: [
             'Abysseil', 'Annelait', 'Azurolt', 'Baloon', 'Baloon-Popped', 'Baloon-Water', 'Catelax', 'Crypterid', 'Deliriophage', 'Detonuke', 'Draglow', 'Draxplosion', 'Fluidrake', 'Fluxtape', 'Fluxtape-Radio', 'Fluxtape-Stereo', 'Gorilax', 'Grievenge', 'Hyperoach', 'Lemotic', 'Lumineel', 'Modolith', 'Monstratus', 'Mortemoth', 'Pokat', 'Spirox', 'Spirox-Ancient', 'Spirox-Ripped', 'Treemu', 'Valianch'
        ],
