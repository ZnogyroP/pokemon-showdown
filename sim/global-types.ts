...
interface FormatsData extends EventMethods {
	...
	onValidateSet?: (
		this: TeamValidator, set: PokemonSet, format: Format, setHas: AnyObject, teamHas: AnyObject, ruleTable: RuleTable
	) => string[] | void;
	onValidateTeam?: (this: TeamValidator, team: PokemonSet[], format: Format, teamHas: AnyObject, ruleTable: RuleTable) => string[] | void;
...
interface ModdedBattleScriptsData extends Partial<BattleScriptsData> {
	...
	getEffect?: (this: ModdedDex, name: string | Effect | null) => Effect; // TrashChannel: Changed this: Battle to ModdedDex
